...
Further, we run a two-sample t-test to see if Japanese video game sales (in millions of units) differ from American video game sales (in millions units).   Lastly, we use a 90% confidence interval to find the average global sale (in millions of units) of video games on a variety of consoles (PS4, xbox One and WiiU).

### Results
$H_0: \rho = 0$  
$H_a: \rho > 0$  
where $\rho$ is the true population coefficient between Global Sales (in millions of units) and Critic Score for all video games.
